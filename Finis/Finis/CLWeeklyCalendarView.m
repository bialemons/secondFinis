...
-(UIView *)dailyInfoSubViewContainer
{
    ...
    if(!_dailyInfoSubViewContainer){
        _dailyInfoSubViewContainer = [[UIView alloc] initWithFrame:CGRectMake(0, 0 + 10 + DATE_VIEW_MARGIN * 2, self.bounds.size.width, DATE_LABEL_INFO_HEIGHT)];
...
-(UIView *)dayTitleSubViewContainer
{
    if(!_dayTitleSubViewContainer) {
        _dayTitleSubViewContainer = [[UIImageView alloc] initWithFrame:CGRectMake(0, 105, self.bounds.size.width, DAY_TITLE_VIEW_HEIGHT)];
...
-(UIView *)dailySubViewContainer
{
    if(!_dailySubViewContainer){
        _dailySubViewContainer = [[UIImageView alloc] initWithFrame:CGRectMake(0, 50 + DAY_TITLE_VIEW_HEIGHT+DATE_VIEW_MARGIN, self.bounds.size.width, DATE_VIEW_HEIGHT)];
